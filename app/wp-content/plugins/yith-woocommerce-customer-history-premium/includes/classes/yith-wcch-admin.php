    ...
    class YITH_WCCH_Admin {
        ...
        function admin_menu() {
            ...
            if( ! isset( $admin_page_hooks['yit_plugin_panel'] ) ){
                add_menu_page( 'yit_plugin_panel', __( 'YITH Plugins', 'yith-plugin-fw' ), 'manage_woocommerce', 'yit_plugin_panel', NULL, YIT_CORE_PLUGIN_URL . '/assets/images/yithemes-icon.png', '62.32' );
            }
