...
*/
    class CELP_Settings
    {
        ...
        {
            $this->Base_File = CELP_FILE;
            $this->PLUGIN_NAME = CELP_ApiConf::PLUGIN_NAME;
            $this->PREFIX = CELP_ApiConf::PLUGIN_PREFIX;
            $this->AUTH_PAGE = CELP_ApiConf::PLUGIN_AUTH_PAGE;
            $this->PLUGIN_URL = CELP_ApiConf::PLUGIN_URL;
            $this->PLUGIN_VER = CELP_ApiConf::PLUGIN_VERSION;
            $this->settings_api = new CELP_Settings_API;
            $this->plugin_purchase_url = 'https://1.envato.market/XKkyb';
            $this->plugin_documentation_url = 'https://docs.coolplugins.net/doc/cryptocurrency-exchanges-list-pro/';
        ...
        */
        ...
        {
            add_submenu_page('edit.php?post_type='.$this->PREFIX,'Cool Plugins Product Registration', 'Registration', 'delete_posts', $this->AUTH_PAGE, array($this, 'auth_settings_page'));
        }
        ...
        */
        ...
        function welcome_tab(){
            ...
            <a href="https://1.envato.market/XKkyb" target="_blank" class="celp-ad-banner"><img style="max-width:100%;height:auto;border:2px solid #d8d8d8;padding:4px;" src="https://res.cloudinary.com/pinkborder/image/upload/v1565162802/CoinMarketCap-Plugin/exchanges-plugin-ad.png" /></a><br/>
            <h4>Crypto ICO List Widgets Pro</h4>
            <a href="https://1.envato.market/JWnb7" target="_blank" class="cilwp-ad-banner"><img style="max-width:100%;height:auto;border:2px solid #d8d8d8;padding:4px;" src="https://res.cloudinary.com/pinkborder/image/upload/v1565162803/CoinMarketCap-Plugin/ico-plugin-ad.png" /></a><br/>
            <h4>Cryptocurrency Search Add-on</h4>
            <a href="https://1.envato.market/aZv5q" target="_blank" class="csa-ad-banner"><img style="max-width:100%;height:auto;border:2px solid #d8d8d8;padding:4px;" src="https://res.cloudinary.com/pinkborder/image/upload/v1565162802/CoinMarketCap-Plugin/search-addon-ad.png" /></a><br/>
            <h4>Cryptocurrency Widgets Pro</h4>
            <a href="https://1.envato.market/9raoE" target="_blank" class="cwp-ad-banner"><img style="max-width:100%;height:auto;border:2px solid #d8d8d8;padding:4px;" src="https://res.cloudinary.com/pinkborder/image/upload/v1565162802/CoinMarketCap-Plugin/widgets-pro-ad.png" /></a><br/>
            <h4>Coins Marketcap</h4>
            <a href="https://1.envato.market/JWXb7" target="_blank" class="cmc-ad-banner"><img style="max-width:100%;height:auto;border:2px solid #d8d8d8;padding:4px;" src="https://res.cloudinary.com/pinkborder/image/upload/v1565162803/CoinMarketCap-Plugin/coins-marketcap-ad.png" /></a>
            </p>';
        ...
        public function ValidatePurchase()
        {
           ...
           if( isset( $_GET['settings-updated'] ) || !empty($purchase) )
           {
                if( !empty( $purchase ) ){
                    ...
                    $verified = CryptocurrencyExchangesListProBase::CheckWPPlugin($purchase,$admin_email,$this->licenseMessage,$this->Response,$this->Base_File);
        ...
        */
        function uninstall_license(){
            ...
            if( wp_verify_nonce( $_REQUEST['_password'], 'purchase-verify'  ) == true ){
               $response = CryptocurrencyExchangesListProBase::RemoveLicenseKey($this->Base_File,$message);
        ...
        */
        function admin_registration_notice(){
            set_transient($this->PREFIX . '_api_data_verification', 'done');
            ...
            ?>
                <div class="license-warning notice notice-error is-dismissible">
                    <p>Hi, <strong><?php echo ucwords( $user_name ); ?></strong>! Please <strong><a href="<?php echo esc_url( get_admin_url( null, 'edit.php?post_type='.$this->PREFIX.'&page='.$this->AUTH_PAGE.'#'.$this->PREFIX.'_license_registration' ) ); ?>">enter and activate</a></strong> your license key for <strong><?php echo $this->PLUGIN_NAME;?></strong> plugin for unrestricted and full access of all premium features.</p>
                </div>
            <?php
        }
