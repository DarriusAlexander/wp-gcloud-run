...
if ( ! class_exists( 'LoginPress_HideLogin_Main' ) ) :
    ...
    */
    public function textdomain() {
      ...
      load_plugin_textdomain( 'loginpress-hide-login', false, LOGINPRESS_HIDE_PLUGIN_BASENAME . '/languages/' );
    }
      ...
      return $html;
		...
		public function loginpress_send_notify_email() {
			...
			if ( ! empty( $slug ) && ! empty( $email )  ) {
				...
				wp_mail( trim( $email ), "Rename wp-login.php by LoginPress", $message, $headers );
			}
		}
