...
if ( ! class_exists( 'LoginPress_Login_Redirect_Main' ) ) :
    ...
    */
    public function textdomain() {
      ...
      load_plugin_textdomain( 'loginpress-login-redirects', false, LOGINPRESS_REDIRECT_PLUGIN_BASENAME . '/languages/' );
    }
		...
		function _admin_scripts( $hook ) {
			...
			wp_enqueue_script( 'loginpress_login_redirect_js', plugins_url( '../assets/js/autologin.js', __FILE__ ), array(), LOGINPRESS_REDIRECT_VERSION );
