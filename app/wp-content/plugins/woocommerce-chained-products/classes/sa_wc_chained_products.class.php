...
class SA_WC_Chained_Products {
	...
	public function __construct() {
        ...
        if ( class_exists('WC_Subscriptions') ) {
	        ...
	        add_action( 'woocommerce_order_add_product', array( &$this, 'add_chained_product_meta_to_subscription' ), 10, 5 );
        }
    ...
    /**
	 * Add chained product custom meta to a subscription
	 *
	 * @param int $id
	 * @param int $item_id
	 ...
	 * @param array $args
	 */
	public function add_chained_product_meta_to_subscription( $id, $item_id, $product, $qty, $args ) {
		if( isset( $args['chained_product_of'] ) ) {
            wc_update_order_item_meta( $item_id, '_chained_product_of', $args['chained_product_of'] );
  		}
	}
