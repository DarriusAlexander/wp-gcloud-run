    ...
    <table class="form-table">
      <tbody>
        <tr valign="top">
          ...
          <td>
            <input id="loginpress_pro_license_key" placeholder="Enter your license key" name="loginpress_pro_license_key" type="text" class="regular-text" value="<?php echo LoginPress_Pro::mask_license( $license ); ?>" />
            <label class="description" for="loginpress_pro_license_key"><?php _e('Validating license key is mandatory to use automatic updates and plugin support.'); ?></label>
          </td>
        </tr>
          ...
          <tr valign="top">
            ...
            <td>
              <?php if( LoginPress_Pro::is_registered() ) { ?>
                ...
                <input type="submit" class="button-secondary" name="loginpress_pro_license_deactivate" value="<?php _e('Deactivate License'); ?>"/>
              <?php } else {
                wp_nonce_field( 'loginpress_pro_license_nonce', 'loginpress_pro_license_nonce' ); ?>
                <input type="submit" class="button-secondary" name="loginpress_pro_license_activate" value="<?php _e('Activate License'); ?>"/>
            </td>
          </tr>
        <?php } ?>
        <tr><th></th><td>
