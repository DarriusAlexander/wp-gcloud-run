  ...
  class LoginPress_Limit_Login_Attempts_Main {
    ...
    * * * * * * * * */
    public function textdomain() {
      ...
      load_plugin_textdomain( 'loginpress-limit-login-attempts', false, LOGINPRESS_LIMIT_LOGIN_PLUGIN_BASENAME . '/languages/' );
    }
    ...
    * * * * * * * * * * * * * * * * */
    function loginpress_limit_login_attempts_log_callback() {
      ...
      $html = '<table id="loginpress_limit_login_log" class="display" cellspacing="0" width="100%">
        <thead>
          <tr>
            <th>IP</th>
            <th>Date & Time</th>
