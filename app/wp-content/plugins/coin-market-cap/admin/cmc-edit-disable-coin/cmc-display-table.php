...
class cmc_list_table extends CMC_WP_List_Table
{
    public function __construct()
    {
        ...
        }else if( !isset($_REQUEST['s']) && isset($_SESSION['cmc-coin-search'])){
            $_REQUEST['s'] = $_SESSION['cmc-coin-search'];
        }
    ...
    */
    ...
    function column_name( $item ) {
        ...
        $title = '<strong>' .$item->name. '</strong><br/><a href="'.$coin_url.'" target="_new">View</span>';
    ...
    */
    function cmc_perform_row_actions(){
        GLOBAL $wpdb;
        $giphy_table = $wpdb->base_prefix . 'cmc_coins';
    ...
    */
    public function prepare_items()
    {
        ...
        $query = 'SELECT * FROM ' . $wpdb->base_prefix . 'cmc_coins';
       /*  $this->cmc_process_bulk_action();
        ...
        if( !empty($user_search_keyword) ){
            $_SESSION['cmc-coin-search'] = $user_search_keyword;
        }else if(isset($_SESSION['cmc-coin-search']) && empty($user_search_keyword) ){
            $user_search_keyword = $_SESSION['cmc-coin-search'];
        }
        ...
        $columns = $this->get_column_info();
                    ...
                    switch ($column_name) {
                        ...
                        case "disable_coin":
                            ...
                            $btnHtml = '<label data-coin-id="'.$item->coin_id.'" data-coin-name="'.$item->name.'" data-ajax-url="'.$ajax_url.'" data-disable_coin_nonce="'.$disable_coin_nonce.'" class="cmc-disable-button '.$btn_action.'" title="'.$title.'">
