...
height:"auto"}),c(".tb_slider_loader").remove(),c(g).triggerHandler("resize");else{m?(u.mousewheel=!0,u.swipe={onMouse:!0,onTouch:!0},u.items={visible:n},u.scroll={items:2,duration:1E3,timeoutDuration:0,easing:"linear"},u.auto=!1,u.circular=!1,u.infinite=!1):(0<parseInt(b.data("auto-scroll"))?u.auto={play:!0,timeoutDuration:parseInt(1E3*b.data("auto-scroll")),button:".themify_slider_controller"}:"continuously"===b.data("effect")||"undefined"===typeof b.data("auto-scroll")&&0!==parseInt(b.data("auto-scroll"))||
...
"auto"===r&&a(b);t&&"desktop"!==t&&"mobile"!==t||!b.data("mob-visible")||!e()?t&&"mobile"!==t||(t="desktop",b.trigger("finish").trigger("configuration",{items:{visible:b.data("visible")}})):(t="mobile",b.trigger("finish").trigger("configuration",{items:{visible:b.data("mob-visible")}}));b.trigger("updateSizes")})}})};f.imagesLoad(function(){"undefined"===typeof c.fn.carouFredSel?f.LoadAsync(themify_vars.url+"/js/carousel.min.js",h,null,null,function(){return"undefined"!==typeof c.fn.carouFredSel}):
h()})}},addonLoad:function(a,b){if(g.tbLocalScript!==n&&g.tbLocalScript.addons&&0<Object.keys(g.tbLocalScript.addons).length){if(b){if(tbLocalScript.addons[b]===n)return;var c={};c[b]=tbLocalScript.addons[b]}else c=tbLocalScript.addons;for(var e in c)if(null!==p.querySelector(c[e].selector)&&(c[e].css&&f.LoadCss(c[e].css,c[e].ver),c[e].js&&f.LoadAsync(c[e].js,null,c[e].ver,{before:c[e].external}),delete tbLocalScript.addons[e],a))break;f.is_builder_active||(tbLocalScript.addons=null)}},loadOnAjax:function(a,
